...
#define my_MAX1020(x, y) (x) < (y) ? (y) : (x)
#define my_MIN1020(x, y) (y) < (x) ? (y) : (x)
...
/********************
you can not invoke these 4 basic functions
*************************/
void GameWorld::Init()
{
...
LevelStatus GameWorld::Update()
{
  ...
  int allowed = my_MIN1020(toDestroy, maxOnScreen);
  if (onScreen < allowed)
  {
    ++onScreen;
    int P1 = 6;
    int P2 = 2 * my_MAX1020(level - 1, 0);
    int P3 = 3 * my_MAX1020(level - 2, 0);
    int sum = P1 + P2 + P3;
